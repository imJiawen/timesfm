...
sys.path.append('/home/v-zhangjiaw/code/timesfm/src/')
import timesfm
...
# model.load_from_checkpoint(checkpoint_path="/home/v-zhangjiaw/code/timesfm/timesfm_checkpoint/checkpoints")
